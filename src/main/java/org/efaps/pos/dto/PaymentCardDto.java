...
@JsonDeserialize(builder = PaymentCardDto.Builder.class)
    ...
    implements IPaymentDto
{
    ...
    protected PaymentCardDto(final Builder builder)
    {
        super(builder);
        ...
        extends PaymentCardAbstractDto.Builder<Builder>
    {
        ...
        public PaymentCardDto build()
        {
            return new PaymentCardDto(this);
        }
    }
